#
#  Be sure to run `pod spec lint IncludeJTDCategoryViewSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Justin Tsou" => "killkill8250@gmail.com" }
  # Or just: spec.author    = "Justin Tsou"
  # spec.authors            = { "Justin Tsou" => "killkill8250@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Justin Tsou"
  ...
  spec.source       = { :git => "https://github.com/JustinTsouDeveloper/IncludeJTDCategoryViewSDK.git", :tag => spec.version.to_s }
  ...
  spec.vendored_frameworks = "IncludeJTDCategoryViewSDK/JTDCategoryView.framework"
